...
//    [self.contentView.superview addConstraints:horizontalConstraints];
  ...
  //  [self.timeLable autoSetDimensionsToSize:[self.timeLable intrinsicContentSize]];
   ...
   // [self.contentLable autoSetDimensionsToSize:[self.contentLable intrinsicContentSize]];
...
-(void) removeConstraints{
    ...
    //不能把LABLE和BTN的容压这些固有的约束去掉
//    for( UIView* view in self.contentView.subviews)
//    {
//        
//      //  NSLog(@"%@",view.constraints);
//        //"<NSContentSizeLayoutConstraint:0x7f82619edc70 V:[UIButton:0x7f82619d2200(31)] Hug:250 CompressionResistance:750>"
